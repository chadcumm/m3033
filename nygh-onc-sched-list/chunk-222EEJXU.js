...
function ScheduleListComponent_Conditional_2_Conditional_13_For_6_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275domProperty("value", g_r4.id)("selected", ctx_r1.currentGroupSelection() === g_r4.id);
    \u0275\u0275advance();
...
function ScheduleListComponent_Conditional_2_Conditional_13_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275domListener("change", function ScheduleListComponent_Conditional_2_Conditional_13_Template_select_change_2_listener($event) {
      ...
      return \u0275\u0275resetView(ctx_r1.onSuperuserGroupChange($event));
    });
    \u0275\u0275domElementStart(3, "option", 23);
    \u0275\u0275text(4, "All groups");
    \u0275\u0275domElementEnd();
    \u0275\u0275repeaterCreate(5, ScheduleListComponent_Conditional_2_Conditional_13_For_6_Template, 2, 3, "option", 14, _forTrack1);
    \u0275\u0275domElementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(3);
    \u0275\u0275domProperty("selected", ctx_r1.currentGroupSelection() === "__ALL__");
    \u0275\u0275advance(2);
    \u0275\u0275repeater(ctx_r1.allGroups());
  }
}
...
function ScheduleListComponent_Conditional_2_Conditional_30_For_5_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275domListener("dragstart", function ScheduleListComponent_Conditional_2_Conditional_30_For_5_Template_th_dragstart_0_listener($event) {
      const \u0275$index_97_r8 = \u0275\u0275restoreView(_r7).$index;
      const ctx_r1 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r1.onDragStart($event, \u0275$index_97_r8));
    })("dragover", function ScheduleListComponent_Conditional_2_Conditional_30_For_5_Template_th_dragover_0_listener($event) {
      const \u0275$index_97_r8 = \u0275\u0275restoreView(_r7).$index;
      const ctx_r1 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r1.onDragOver($event, \u0275$index_97_r8));
      ...
      const \u0275$index_97_r8 = \u0275\u0275restoreView(_r7).$index;
      const ctx_r1 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r1.onDrop($event, \u0275$index_97_r8));
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext(3);
    \u0275\u0275classProp("drag-over", ctx_r1.dropTargetIndex() === \u0275$index_97_r8)("dragging", ctx_r1.dragColumnIndex() === \u0275$index_97_r8);
    \u0275\u0275advance();
...
function ScheduleListComponent_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(13, ScheduleListComponent_Conditional_2_Conditional_13_Template, 7, 1, "label", 9)(14, ScheduleListComponent_Conditional_2_Conditional_14_Template, 2, 1, "span", 10);
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275conditional(ctx_r1.accessControlService.isSuperuser() ? 13 : ctx_r1.accessControlService.activeGroupLabel() ? 14 : -1);
    \u0275\u0275advance(7);
...
var ScheduleListComponent = class _ScheduleListComponent {
  ...
  allGroups = computed(() => this.configService.configuration()?.APPOINTMENT_TYPE_GROUPS ?? [], ...ngDevMode ? [{ debugName: "allGroups" }] : (
    /* istanbul ignore next */
    []
  ));
  currentGroupSelection = computed(() => {
    const override = this.accessControlService.superuserGroupOverride();
    if (override === SUPERUSER_OVERRIDE_ALL)
      return SUPERUSER_OVERRIDE_ALL;
    if (override)
      return override;
    return this.accessControlService.userGroup()?.id ?? SUPERUSER_OVERRIDE_ALL;
  }, ...ngDevMode ? [{ debugName: "currentGroupSelection" }] : (
    /* istanbul ignore next */
    []
  ));
  ...
  onSuperuserGroupChange(event) {
    const value = event.target.value;
    const next = value === SUPERUSER_OVERRIDE_ALL ? SUPERUSER_OVERRIDE_ALL : value;
    this.accessControlService.setSuperuserGroupOverride(next);
...
(() => {
  ...
  <div class="schedule-header">
    ...
    <div class="header-controls">
      @if (accessControlService.isSuperuser()) {
        <label class="group-filter">
          Group:
          <select class="fusion-input" (change)="onSuperuserGroupChange($event)">
            <option value="__ALL__" [selected]="currentGroupSelection() === '__ALL__'">All groups</option>
            @for (g of allGroups(); track g.id) {
              <option [value]="g.id" [selected]="currentGroupSelection() === g.id">{{ g.label }}</option>
            }
          </select>
        </label>
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ScheduleListComponent, { className: "ScheduleListComponent", filePath: "src/app/components/schedule-list/schedule-list.ts", lineNumber: 23 });
})();
export {
  ScheduleListComponent
};
//# sourceMappingURL=chunk-222EEJXU.js.map

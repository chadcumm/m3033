import {
  PreferencesService,
  ScheduleService
} from "./chunk-VFOZZB66.js";
import {
  AccessControlService
} from "./chunk-2AUROYII.js";
import {
  COLUMN_DEFINITIONS,
  SUPERUSER_OVERRIDE_ALL,
  cellDisplayValue
} from "./chunk-HAYL7TXT.js";
import {
...
function ScheduleListComponent_Conditional_2_Conditional_13_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(3, ScheduleListComponent_Conditional_2_Conditional_13_Conditional_3_Template, 2, 1, "option", 27);
...
function ScheduleListComponent_Conditional_2_Conditional_27_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(1, ScheduleListComponent_Conditional_2_Conditional_27_For_2_Template, 3, 2, "label", 28, _forTrack2);
...
function ScheduleListComponent_Conditional_2_Conditional_34_For_7_For_2_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(1, ScheduleListComponent_Conditional_2_Conditional_34_For_7_For_2_Conditional_0_Conditional_1_Template, 3, 3, "button", 40);
    ...
    \u0275\u0275element(4, "path", 43);
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(5, ScheduleListComponent_Conditional_2_Conditional_34_For_7_For_2_Conditional_0_Conditional_5_Template, 3, 0, "button", 44);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const appt_r14 = \u0275\u0275nextContext(2).$implicit;
...
function ScheduleListComponent_Conditional_2_Conditional_34_For_7_For_2_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(1);
    \u0275\u0275conditionalCreate(2, ScheduleListComponent_Conditional_2_Conditional_34_For_7_For_2_Conditional_3_Conditional_2_Template, 3, 1, "span", 51);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const col_r16 = \u0275\u0275nextContext().$implicit;
...
function ScheduleListComponent_Conditional_2_Conditional_34_For_7_For_2_Conditional_4_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(2, "path", 57);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(3, ScheduleListComponent_Conditional_2_Conditional_34_For_7_For_2_Conditional_4_Conditional_1_Conditional_3_Template, 2, 1, "span", 58);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const appt_r14 = \u0275\u0275nextContext(3).$implicit;
...
function ScheduleListComponent_Conditional_2_Conditional_34_For_7_For_2_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(1, ScheduleListComponent_Conditional_2_Conditional_34_For_7_For_2_Conditional_4_Conditional_1_Template, 4, 4, "button", 54)(2, ScheduleListComponent_Conditional_2_Conditional_34_For_7_For_2_Conditional_4_Conditional_2_Template, 2, 0, "span", 55);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const appt_r14 = \u0275\u0275nextContext(2).$implicit;
...
function ScheduleListComponent_Conditional_2_Conditional_34_For_7_For_2_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "td");
    \u0275\u0275text(1);
    \u0275\u0275conditionalCreate(2, ScheduleListComponent_Conditional_2_Conditional_34_For_7_For_2_Conditional_5_Conditional_2_Template, 2, 2, "span", 59);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const appt_r14 = \u0275\u0275nextContext(2).$implicit;
...
function ScheduleListComponent_Conditional_2_Conditional_34_For_7_For_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275conditionalCreate(0, ScheduleListComponent_Conditional_2_Conditional_34_For_7_For_2_Conditional_0_Template, 6, 2, "td", 36)(1, ScheduleListComponent_Conditional_2_Conditional_34_For_7_For_2_Conditional_1_Template, 3, 3, "td")(2, ScheduleListComponent_Conditional_2_Conditional_34_For_7_For_2_Conditional_2_Template, 2, 2, "td", 37)(3, ScheduleListComponent_Conditional_2_Conditional_34_For_7_For_2_Conditional_3_Template, 3, 4, "td", 38)(4, ScheduleListComponent_Conditional_2_Conditional_34_For_7_For_2_Conditional_4_Template, 3, 1, "td", 39)(5, ScheduleListComponent_Conditional_2_Conditional_34_For_7_For_2_Conditional_5_Template, 3, 2, "td")(6, ScheduleListComponent_Conditional_2_Conditional_34_For_7_For_2_Conditional_6_Template, 2, 1, "td");
  }
  if (rf & 2) {
...
function ScheduleListComponent_Conditional_2_Conditional_34_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(3, ScheduleListComponent_Conditional_2_Conditional_34_For_4_Template, 3, 14, "th", 33, _forTrack2);
    \u0275\u0275elementEnd()();
...
function ScheduleListComponent_Conditional_2_Conditional_36_Template(rf, ctx) {
  if (rf & 1) {
...
function ScheduleListComponent_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(36, ScheduleListComponent_Conditional_2_Conditional_36_Template, 2, 1, "span")(37, ScheduleListComponent_Conditional_2_Conditional_37_Template, 2, 0, "span");
    \u0275\u0275conditionalCreate(38, ScheduleListComponent_Conditional_2_Conditional_38_Template, 2, 1, "span");
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275advance(3);
    \u0275\u0275conditional(ctx_r1.scheduleService.refreshIntervalSeconds() > 0 ? 36 : 37);
    \u0275\u0275advance(2);
    \u0275\u0275conditional(ctx_r1.scheduleService.lastUpdated() ? 38 : -1);
  }
}
function ScheduleListComponent_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
    const _r18 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "app-labs-modal", 60);
  ...
  if (rf & 2) {
    ...
    const appt_r19 = ctx;
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275property("patientName", appt_r19.patient_name)("labs", appt_r19.labs)("labOrders", appt_r19.lab_orders)("lookbackHours", ((tmp_5_0 = ctx_r1.accessControlService.resolvedLabConfig()) == null ? null : tmp_5_0.lookback_hours) ?? null);
  }
}
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ScheduleListComponent, { className: "ScheduleListComponent", filePath: "src/app/components/schedule-list/schedule-list.ts", lineNumber: 25 });
})();
export {
  ScheduleListComponent
};
//# sourceMappingURL=chunk-GIASB5F3.js.map

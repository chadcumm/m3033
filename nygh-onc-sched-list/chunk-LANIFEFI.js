...
function SecurityComponent_Conditional_7_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275domElementStart(1, "option", 11);
    \u0275\u0275text(2, "Select position...");
    \u0275\u0275domElementEnd();
    \u0275\u0275repeaterCreate(3, SecurityComponent_Conditional_7_For_4_Template, 2, 2, "option", 12, _forTrack0);
    \u0275\u0275domElementEnd();
    \u0275\u0275domElementStart(5, "button", 13);
...
function SecurityComponent_Conditional_13_For_13_For_6_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275domElementStart(0, "td", 16)(1, "input", 17);
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance();
    \u0275\u0275domProperty("checked", ctx_r1.hasTabAccess(position_r6, tab_r8.key));
  }
}
function SecurityComponent_Conditional_13_For_13_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(2);
    \u0275\u0275domElementEnd();
    \u0275\u0275domElementStart(3, "td", 16)(4, "input", 17);
    ...
    \u0275\u0275domElementEnd()();
    \u0275\u0275repeaterCreate(5, SecurityComponent_Conditional_13_For_13_For_6_Template, 2, 1, "td", 16, _forTrack1);
    \u0275\u0275domElementStart(7, "td")(8, "button", 18);
...
function SecurityComponent_Conditional_13_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275domElementStart(0, "div", 5)(1, "table", 14)(2, "thead")(3, "tr")(4, "th");
    \u0275\u0275text(5, "Position");
    \u0275\u0275domElementEnd();
...
var SecurityComponent = class _SecurityComponent {
  ...
  ngOnInit() {
    this.codeValueService.load(88, 0, "", "", "", false, () => {
      const cvs = this.codeValueService.getCodeSet(88);
    ...
    if (config) {
      ...
      this.editableConfig.set({ superusers: [], tabs: {} });
    }
  }
  ...
  save() {
    ...
    this.statusMessage.set({ type: "success", text: "Security settings saved." });
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SecurityComponent, selectors: [["app-security"]], decls: 20, vars: 5, consts: [[1, "security-container"], [1, "security-section"], [1, "add-position"], [1, "loading-msg"], [1, "empty-msg"], [1, "matrix-container"], [1, "security-actions"], [1, "save-btn", 3, "click", "disabled"], [1, "discard-btn", 3, "click", "disabled"], [1, "status-msg", 3, "class"], [3, "change"], ["value", ""], [3, "value"], [1, "add-btn", 3, "click", "disabled"], [1, "matrix-table"], [1, "position-name"], [1, "checkbox-cell"], ["type", "checkbox", 3, "change", "checked"], ["title", "Remove position", 1, "remove-btn", 3, "click"], [1, "status-msg"]], template: function SecurityComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275text(18, "Discard");
      \u0275\u0275domElementEnd();
      \u0275\u0275conditionalCreate(19, SecurityComponent_Conditional_19_Template, 2, 3, "span", 9);
      \u0275\u0275domElementEnd()();
    }
    if (rf & 2) {
      \u0275\u0275advance(7);
      ...
      \u0275\u0275advance(2);
      \u0275\u0275conditional(ctx.statusMessage() ? 19 : -1);
    }
...
//# sourceMappingURL=chunk-LANIFEFI.js.map

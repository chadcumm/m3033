...
function ConfigComponent_For_50_For_6_Template(rf, ctx) {
  if (rf & 1) {
    const _r10 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "label")(1, "input", 44);
    \u0275\u0275listener("change", function ConfigComponent_For_50_For_6_Template_input_change_1_listener() {
      const p_r11 = \u0275\u0275restoreView(_r10).$implicit;
      const \u0275$index_131_r12 = \u0275\u0275nextContext().$index;
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.toggleRulePosition(\u0275$index_131_r12, p_r11.display));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("checked", rule_r13.positions.includes(p_r11.display));
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", p_r11.display, " ");
  }
}
function ConfigComponent_For_50_For_12_Template(rf, ctx) {
  if (rf & 1) {
    const _r14 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "label")(1, "input", 44);
    \u0275\u0275listener("change", function ConfigComponent_For_50_For_12_Template_input_change_1_listener() {
      const col_r15 = \u0275\u0275restoreView(_r14).$implicit;
      const \u0275$index_131_r12 = \u0275\u0275nextContext().$index;
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.toggleRuleColumn(\u0275$index_131_r12, col_r15.key));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
...
function ConfigComponent_For_50_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(5, ConfigComponent_For_50_For_6_Template, 3, 2, "label", null, _forTrack2);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(7, "div", 43)(8, "strong");
    \u0275\u0275text(9, "Hidden columns");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(10, "div", 21);
    \u0275\u0275repeaterCreate(11, ConfigComponent_For_50_For_12_Template, 3, 2, "label", null, _forTrack3);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(13, "button", 37);
    \u0275\u0275listener("click", function ConfigComponent_For_50_Template_button_click_13_listener() {
      const \u0275$index_131_r12 = \u0275\u0275restoreView(_r9).$index;
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.removeColumnRule(\u0275$index_131_r12));
    });
    \u0275\u0275text(14, "Remove rule");
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance(5);
    \u0275\u0275repeater(ctx_r2.allPositions());
    \u0275\u0275advance(6);
...
function ConfigComponent_For_62_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "label")(1, "input", 45);
...
var ConfigComponent = class _ConfigComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ConfigComponent, selectors: [["app-config"]], decls: 90, vars: 15, consts: [[1, "config-container"], [1, "fusion-panel"], [1, "fusion-panel-header"], [1, "fusion-panel-body"], [1, "groups-master-detail"], [1, "groups-list"], [1, "groups-list-empty"], ["type", "button", 1, "fusion-button", "fusion-outline", "new-group-btn", 3, "click"], [1, "group-editor"], [3, "group", "otherGroups", "allPositions", "allApptTypes", "apptTypesLoaded", "positionsLoaded"], [1, "group-editor-empty"], [1, "refresh-interval-row"], ["for", "refreshIntervalInput", 1, "refresh-interval-label"], ["id", "refreshIntervalInput", "type", "number", "step", "1", 1, "fusion-input", "refresh-interval-input", 3, "input", "min", "max", "value", "disabled"], ["type", "button", 1, "fusion-button", "fusion-outline", "fusion-small", 3, "click"], [1, "refresh-interval-hint"], [1, "loading-msg"], [1, "encntr-type-row"], [1, "panel-help"], [1, "column-rule"], ["type", "button", 1, "fusion-button", "fusion-small", 3, "click"], [1, "checkbox-grid"], ["type", "text", "placeholder", "Chair", 1, "fusion-input", 3, "input", "value"], [1, "config-actions"], ["type", "button", 1, "fusion-button", 3, "click", "disabled"], ["type", "button", 1, "fusion-button", "fusion-outline", 3, "click", "disabled"], [1, "status-message"], [1, "status-message", "status-error"], [1, "config-version"], [1, "group-row", 3, "selected"], [1, "group-row", 3, "click"], [1, "group-row-main"], [1, "group-row-label"], [1, "group-row-meta"], [1, "group-row-delete-confirm"], ["type", "button", "aria-label", "Delete group", "title", "Delete group", 1, "group-row-delete"], [1, "group-row-delete-confirm", 3, "click"], ["type", "button", 1, "fusion-button", "fusion-danger", "fusion-small", 3, "click"], ["type", "button", "aria-label", "Delete group", "title", "Delete group", 1, "group-row-delete", 3, "click"], [3, "groupChange", "group", "otherGroups", "allPositions", "allApptTypes", "apptTypesLoaded", "positionsLoaded"], ["for", "chartLinkEncntrType", 1, "encntr-type-label"], ["id", "chartLinkEncntrType", 1, "fusion-input", "encntr-type-select", 3, "change"], [3, "value", "selected"], [1, "column-rule-section"], ["type", "checkbox", 3, "change", "checked"], ["type", "checkbox", 3, "change", "checked", "disabled"]], template: function ConfigComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275elementEnd();
      \u0275\u0275repeaterCreate(49, ConfigComponent_For_50_Template, 15, 0, "div", 19, \u0275\u0275repeaterTrackByIndex);
      ...
      \u0275\u0275text(59, " Only appointments in these scheduling states appear on the list. The default (Confirmed, Checked In, Checked Out, Scheduled) excludes rescheduled, canceled, and no-show entries. At least one state must be selected. ");
      \u0275\u0275elementEnd();
        ...
        <div class="column-rule">
          <div class="column-rule-section">
            ...
            <div class="checkbox-grid">
              @for (p of allPositions(); track p.display) {
                <label>
  ...
  <div class="fusion-panel">
    ...
    <div class="fusion-panel-body">
      <p class="panel-help">
        ...
        (Confirmed, Checked In, Checked Out, Scheduled) excludes rescheduled, canceled,
        and no-show entries. At least one state must be selected.
      </p>
      <div class="checkbox-grid">
...
//# sourceMappingURL=chunk-55YVOMOP.js.map

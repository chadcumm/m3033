...
function ConfigComponent_Conditional_9_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275domElementStart(0, "div", 9)(1, "input", 10);
    ...
    \u0275\u0275text(3);
    \u0275\u0275domElementEnd()();
    \u0275\u0275domElementStart(4, "div", 12)(5, "button", 13);
    ...
    \u0275\u0275text(10);
    \u0275\u0275domElementEnd();
    \u0275\u0275conditionalCreate(11, ConfigComponent_Conditional_9_Conditional_11_Template, 2, 1, "span", 15);
    \u0275\u0275domElementEnd();
    \u0275\u0275domElementStart(12, "div", 16);
    \u0275\u0275repeaterCreate(13, ConfigComponent_Conditional_9_For_14_Template, 3, 4, "label", 17, _forTrack0);
    \u0275\u0275domElementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
var ConfigComponent = class _ConfigComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ConfigComponent, selectors: [["app-config"]], decls: 16, vars: 4, consts: [[1, "config-container"], [1, "fusion-panel"], [1, "fusion-panel-header"], [1, "fusion-panel-body"], [1, "loading-msg"], [1, "config-actions"], [1, "fusion-button", 3, "click", "disabled"], [1, "fusion-button", "fusion-outline", 3, "click", "disabled"], [1, "status-message"], [1, "appt-type-controls"], ["type", "text", "placeholder", "Search appointment types...", 1, "fusion-input", "search-input", 3, "input", "value"], [1, "selected-count"], [1, "bulk-actions"], [1, "fusion-button", "fusion-outline", "fusion-small", 3, "click"], [1, "fusion-button", "fusion-small", 3, "click"], [1, "bulk-hint"], [1, "appt-type-list"], [1, "appt-type-item", 3, "selected"], [1, "appt-type-item"], ["type", "checkbox", 3, "change", "checked"]], template: function ConfigComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275text(14, "Discard");
      \u0275\u0275domElementEnd();
      \u0275\u0275conditionalCreate(15, ConfigComponent_Conditional_15_Template, 2, 1, "span", 8);
      \u0275\u0275domElementEnd()();
    }
    if (rf & 2) {
      \u0275\u0275advance(8);
...
//# sourceMappingURL=chunk-22R5ZJ5A.js.map

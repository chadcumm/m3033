...
function ScheduleListComponent_Conditional_27_For_7_For_2_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275domElementStart(0, "td", 24)(1, "a", 26);
    \u0275\u0275domListener("click", function ScheduleListComponent_Conditional_27_For_7_For_2_Conditional_2_Template_a_click_1_listener() {
      \u0275\u0275restoreView(_r9);
      const appt_r7 = \u0275\u0275nextContext(2).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(2);
...
function ScheduleListComponent_Conditional_27_For_7_For_2_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275domElementStart(0, "td")(1, "a", 26);
    \u0275\u0275domListener("click", function ScheduleListComponent_Conditional_27_For_7_For_2_Conditional_3_Template_a_click_1_listener() {
      \u0275\u0275restoreView(_r10);
      const appt_r7 = \u0275\u0275nextContext(2).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(2);
...
function ScheduleListComponent_Conditional_27_For_7_For_2_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
...
function ScheduleListComponent_Conditional_27_For_7_For_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275conditionalCreate(0, ScheduleListComponent_Conditional_27_For_7_For_2_Conditional_0_Template, 3, 3, "td")(1, ScheduleListComponent_Conditional_27_For_7_For_2_Conditional_1_Template, 2, 2, "td", 23)(2, ScheduleListComponent_Conditional_27_For_7_For_2_Conditional_2_Template, 3, 1, "td", 24)(3, ScheduleListComponent_Conditional_27_For_7_For_2_Conditional_3_Template, 3, 1, "td")(4, ScheduleListComponent_Conditional_27_For_7_For_2_Conditional_4_Template, 2, 1, "td");
  }
  if (rf & 2) {
...
function ScheduleListComponent_Conditional_27_For_7_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(1, ScheduleListComponent_Conditional_27_For_7_For_2_Template, 5, 1, null, null, _forTrack1);
    \u0275\u0275domElementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
            ...
            <tr>
              @for (col of orderedColumns(); track col.key) {
                @if (col.key === 'appt_status') {
                  ...
                  <td class="patient-name"><a href="javascript:void(0)" (click)="onOpenChart(appt)">{{ getCellValue(appt, col.key) }}</a></td>
...
//# sourceMappingURL=chunk-IAVCSX2Q.js.map

...
function ScheduleListComponent_Conditional_2_Conditional_34_For_7_For_2_Conditional_3_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(1, "app-encntr-indicator-icon", 59);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const appt_r14 = \u0275\u0275nextContext(3).$implicit;
    const ctx_r1 = \u0275\u0275nextContext(3);
    \u0275\u0275classMap(\u0275\u0275interpolate1("encntr-indicator ", ctx_r1.indicatorCssClass(appt_r14)));
    \u0275\u0275property("title", ctx_r1.indicatorTitle(appt_r14));
    \u0275\u0275attribute("aria-label", ctx_r1.indicatorAriaLabel(appt_r14));
    \u0275\u0275advance();
    \u0275\u0275property("category", ctx_r1.indicatorCategory(appt_r14));
  }
}
...
function ScheduleListComponent_Conditional_2_Conditional_34_For_7_For_2_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(1);
    \u0275\u0275conditionalCreate(2, ScheduleListComponent_Conditional_2_Conditional_34_For_7_For_2_Conditional_3_Conditional_2_Template, 2, 6, "span", 56);
    \u0275\u0275conditionalCreate(3, ScheduleListComponent_Conditional_2_Conditional_34_For_7_For_2_Conditional_3_Conditional_3_Template, 2, 1, "div", 57);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const col_r16 = \u0275\u0275nextContext().$implicit;
...
function ScheduleListComponent_Conditional_2_Conditional_34_For_7_For_2_Conditional_4_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(2, "path", 63);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(3, ScheduleListComponent_Conditional_2_Conditional_34_For_7_For_2_Conditional_4_Conditional_1_Conditional_3_Template, 2, 1, "span", 64);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const appt_r14 = \u0275\u0275nextContext(3).$implicit;
...
function ScheduleListComponent_Conditional_2_Conditional_34_For_7_For_2_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(1, ScheduleListComponent_Conditional_2_Conditional_34_For_7_For_2_Conditional_4_Conditional_1_Template, 4, 4, "button", 60)(2, ScheduleListComponent_Conditional_2_Conditional_34_For_7_For_2_Conditional_4_Conditional_2_Template, 2, 0, "span", 61);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const appt_r14 = \u0275\u0275nextContext(2).$implicit;
...
function ScheduleListComponent_Conditional_2_Conditional_34_For_7_For_2_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "td");
    \u0275\u0275text(1);
    \u0275\u0275conditionalCreate(2, ScheduleListComponent_Conditional_2_Conditional_34_For_7_For_2_Conditional_5_Conditional_2_Template, 2, 2, "span", 65);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const appt_r14 = \u0275\u0275nextContext(2).$implicit;
...
function ScheduleListComponent_Conditional_2_Conditional_46_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 31)(1, "div", 66)(2, "strong");
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "ul");
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(7, "div", 66)(8, "strong");
    \u0275\u0275text(9, "States shown");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(10, "div");
    \u0275\u0275text(11);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(12, "div", 66)(13, "strong");
    \u0275\u0275text(14, "Inpatient/ED indicator types");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(15, "div");
    \u0275\u0275text(16);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(17, "div", 66)(18, "strong");
    \u0275\u0275text(19, "Chair pattern");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(20, "div");
    \u0275\u0275text(21);
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(22, ScheduleListComponent_Conditional_2_Conditional_46_Conditional_22_Template, 5, 1, "div", 66);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
...
function ScheduleListComponent_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "app-labs-modal", 67);
...
var ScheduleListComponent = class _ScheduleListComponent {
  ...
  sortedAppointments = computed(() => {
    ...
    if (!sortCol || !sortDir) {
      return [...appointments].sort((a, b) => a.patient_name.localeCompare(b.patient_name) || a.instance_dt.localeCompare(b.instance_dt));
    }
    return [...appointments].sort((a, b) => {
      const key = sortCol === "appt_date" ? "instance_dt" : sortCol;
      const aVal = a[key] ?? "";
      const bVal = b[key] ?? "";
  ...
  indicatorCssClass(appt) {
    return ENCNTR_INDICATOR_DEFS.find((d) => d.category === this.indicatorCategory(appt))?.cssClass ?? "";
  }
  /**
   * Sentence-friendly label used when active_encntr_type is blank. Preserves
   * the original emergency/inpatient fallback text exactly; 'other' is
   * handled separately (its blank-type behavior differs — see indicatorTitle).
   */
  indicatorFallbackLabel(category) {
    return (ENCNTR_INDICATOR_DEFS.find((d) => d.category === category)?.label ?? category).toLowerCase();
  }
  indicatorTitle(appt) {
    const category = this.indicatorCategory(appt);
    if (category === "other") {
      return appt.active_encntr_type ? `Active ${appt.active_encntr_type} encounter` : "Active encounter";
    }
    return `Active ${appt.active_encntr_type || this.indicatorFallbackLabel(category)} encounter`;
  }
  indicatorAriaLabel(appt) {
    const category = this.indicatorCategory(appt);
    if (category === "other")
      return "Active encounter";
    return `Active ${this.indicatorFallbackLabel(category)} encounter`;
  }
                ...
                @if (col.key === 'actions') {
                  ...
                  <td class="patient-name" [class.has-encounter]="!!appt.encntr_id">
                    ...
                    @if (appt.active_encntr_ind) {
                      <span
                        class="encntr-indicator {{ indicatorCssClass(appt) }}"
                        [title]="indicatorTitle(appt)"
                        [attr.aria-label]="indicatorAriaLabel(appt)"
                        role="img"
                      >
                        <app-encntr-indicator-icon [category]="indicatorCategory(appt)" />
                      </span>
                    }
                    @if (appt.mrn) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ScheduleListComponent, { className: "ScheduleListComponent", filePath: "src/app/components/schedule-list/schedule-list.ts", lineNumber: 32 });
})();
export {

...
function ScheduleListComponent_Conditional_29_For_8_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
    const _r9 = \u0275\u0275getCurrentView();
    \u0275\u0275domElementStart(0, "button", 30);
    \u0275\u0275domListener("click", function ScheduleListComponent_Conditional_29_For_8_Conditional_5_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r9);
      const appt_r8 = \u0275\u0275nextContext().$implicit;
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.onOpenOrderInfo(appt_r8));
    });
    \u0275\u0275namespaceSVG();
...
function ScheduleListComponent_Conditional_29_For_8_For_7_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275domElementStart(0, "td")(1, "span", 34);
    \u0275\u0275text(2);
    \u0275\u0275domElementEnd()();
  }
  if (rf & 2) {
    const appt_r8 = \u0275\u0275nextContext(2).$implicit;
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance();
    \u0275\u0275classMap(ctx_r1.getStatusClass(appt_r8.appt_status));
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(appt_r8.appt_status || "\u2014");
  }
}
function ScheduleListComponent_Conditional_29_For_8_For_7_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275domElementStart(0, "td", 32);
    \u0275\u0275text(1);
    \u0275\u0275domElementEnd();
  }
  if (rf & 2) {
    ...
    const appt_r8 = \u0275\u0275nextContext().$implicit;
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275domProperty("title", appt_r8.special_instructions || "");
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(ctx_r1.getCellValue(appt_r8, col_r10.key));
  }
}
function ScheduleListComponent_Conditional_29_For_8_For_7_Conditional_2_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r11 = \u0275\u0275getCurrentView();
    \u0275\u0275domElementStart(0, "a", 36);
    \u0275\u0275domListener("click", function ScheduleListComponent_Conditional_29_For_8_For_7_Conditional_2_Conditional_1_Template_a_click_0_listener() {
      \u0275\u0275restoreView(_r11);
      const appt_r8 = \u0275\u0275nextContext(3).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.onOpenChart(appt_r8));
    });
    \u0275\u0275text(1);
    \u0275\u0275domElementEnd();
  }
...
function ScheduleListComponent_Conditional_29_For_8_For_7_Conditional_2_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275text(0);
  }
  if (rf & 2) {
    ...
    const appt_r8 = \u0275\u0275nextContext().$implicit;
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275textInterpolate1(" ", ctx_r1.getCellValue(appt_r8, col_r10.key), " ");
  }
}
function ScheduleListComponent_Conditional_29_For_8_For_7_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275domElementStart(0, "td", 33);
    \u0275\u0275conditionalCreate(1, ScheduleListComponent_Conditional_29_For_8_For_7_Conditional_2_Conditional_1_Template, 2, 1, "a", 35)(2, ScheduleListComponent_Conditional_29_For_8_For_7_Conditional_2_Conditional_2_Template, 1, 1);
    \u0275\u0275domElementEnd();
  }
  if (rf & 2) {
    const appt_r8 = \u0275\u0275nextContext(2).$implicit;
    \u0275\u0275advance();
    \u0275\u0275conditional(appt_r8.person_id ? 1 : 2);
  }
}
function ScheduleListComponent_Conditional_29_For_8_For_7_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
...
function ScheduleListComponent_Conditional_29_For_8_For_7_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275conditionalCreate(0, ScheduleListComponent_Conditional_29_For_8_For_7_Conditional_0_Template, 3, 3, "td")(1, ScheduleListComponent_Conditional_29_For_8_For_7_Conditional_1_Template, 2, 2, "td", 32)(2, ScheduleListComponent_Conditional_29_For_8_For_7_Conditional_2_Template, 3, 1, "td", 33)(3, ScheduleListComponent_Conditional_29_For_8_For_7_Conditional_3_Template, 2, 1, "td");
  }
  if (rf & 2) {
    const col_r10 = ctx.$implicit;
    \u0275\u0275conditional(col_r10.key === "appt_status" ? 0 : col_r10.key === "special_instructions" ? 1 : col_r10.key === "patient_name" ? 2 : 3);
  }
}
function ScheduleListComponent_Conditional_29_For_8_Template(rf, ctx) {
  if (rf & 1) {
    const _r7 = \u0275\u0275getCurrentView();
    \u0275\u0275domElementStart(0, "tr")(1, "td", 25)(2, "button", 26);
    \u0275\u0275domListener("click", function ScheduleListComponent_Conditional_29_For_8_Template_button_click_2_listener() {
      const appt_r8 = \u0275\u0275restoreView(_r7).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.onOpenApptView(appt_r8));
    });
    \u0275\u0275namespaceSVG();
    \u0275\u0275domElementStart(3, "svg", 27);
    \u0275\u0275domElement(4, "path", 28);
    \u0275\u0275domElementEnd()();
    \u0275\u0275conditionalCreate(5, ScheduleListComponent_Conditional_29_For_8_Conditional_5_Template, 3, 0, "button", 29);
    \u0275\u0275domElementEnd();
    \u0275\u0275repeaterCreate(6, ScheduleListComponent_Conditional_29_For_8_For_7_Template, 4, 1, null, null, _forTrack1);
    \u0275\u0275domElementEnd();
  }
  if (rf & 2) {
    const appt_r8 = ctx.$implicit;
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(5);
    \u0275\u0275conditional(appt_r8.order_id ? 5 : -1);
    \u0275\u0275advance();
...
function ScheduleListComponent_Conditional_29_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(7, ScheduleListComponent_Conditional_29_For_8_Template, 8, 1, "tr", null, \u0275\u0275componentInstance().trackBySchEventId, true);
    \u0275\u0275domElementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
var ScheduleListComponent = class _ScheduleListComponent {
  ...
  onOpenChart(appt) {
    if (!appt.person_id)
      return;
    this.mPage.putLog("Opening chart for " + appt.patient_name + (appt.encntr_id ? "" : " (no encounter \u2014 defaulting)"));
    openChart(appt.person_id, appt.encntr_id ?? 0);
  }
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ScheduleListComponent, selectors: [["app-schedule-list"]], decls: 34, vars: 11, consts: [[1, "schedule-container"], [1, "schedule-header"], [1, "date-nav"], [1, "fusion-button", "fusion-outline", "fusion-small", 3, "click"], ["type", "date", 1, "fusion-input", "date-input", 3, "change", "value"], [1, "date-separator"], [1, "fusion-button", "fusion-small", 3, "click", "disabled"], [1, "header-controls"], [1, "physician-filter"], [1, "fusion-input", 3, "change"], ["value", ""], [3, "value", "selected"], [1, "appt-count"], ["title", "Refresh", 1, "fusion-button", "fusion-outline", "fusion-small", 3, "click"], [1, "error-banner"], [1, "loading-overlay"], [1, "table-container"], [1, "empty-state"], [1, "fusion-grid"], [1, "schedule-footer"], [1, "fusion-button", "fusion-danger", "fusion-small", 3, "click"], [1, "spinner"], ["aria-label", "Actions", 1, "actions-col"], ["draggable", "true", 1, "sortable", 3, "drag-over", "dragging"], ["draggable", "true", 1, "sortable", 3, "dragstart", "dragover", "dragleave", "drop", "dragend", "click"], [1, "actions-col"], ["type", "button", "title", "Open appointment view", "aria-label", "Open appointment view", 1, "row-action", 3, "click"], ["viewBox", "0 0 16 16", "width", "14", "height", "14", "aria-hidden", "true"], ["fill", "currentColor", "d", "M4.5 1a.5.5 0 0 1 .5.5V2h6v-.5a.5.5 0 0 1 1 0V2h1.5A1.5 1.5 0 0 1 15 3.5v10A1.5 1.5 0 0 1 13.5 15h-11A1.5 1.5 0 0 1 1 13.5v-10A1.5 1.5 0 0 1 2.5 2H4v-.5a.5.5 0 0 1 .5-.5zM2 6v7.5a.5.5 0 0 0 .5.5h11a.5.5 0 0 0 .5-.5V6H2zm2 2h2v2H4V8zm3 0h2v2H7V8zm3 0h2v2h-2V8zM4 11h2v2H4v-2zm3 0h2v2H7v-2zm3 0h2v2h-2v-2z"], ["type", "button", "title", "Open order details", "aria-label", "Open order details", 1, "row-action"], ["type", "button", "title", "Open order details", "aria-label", "Open order details", 1, "row-action", 3, "click"], ["fill", "currentColor", "d", "M5 1.5A1.5 1.5 0 0 1 6.5 0h3A1.5 1.5 0 0 1 11 1.5V2h2.5A1.5 1.5 0 0 1 15 3.5v11A1.5 1.5 0 0 1 13.5 16h-11A1.5 1.5 0 0 1 1 14.5v-11A1.5 1.5 0 0 1 2.5 2H5v-.5zm1 0V3h4V1.5a.5.5 0 0 0-.5-.5h-3a.5.5 0 0 0-.5.5zM4 6h8v1H4V6zm0 3h8v1H4V9zm0 3h5v1H4v-1z"], [1, "truncate", 3, "title"], [1, "patient-name"], [1, "fusion-badge"], ["href", "javascript:void(0)"], ["href", "javascript:void(0)", 3, "click"]], template: function ScheduleListComponent_Template(rf, ctx) {
    if (rf & 1) {
            ...
            <tr>
              ...
              @for (col of orderedColumns(); track col.key) {
                @if (col.key === 'appt_status') {
                  ...
                  <td class="patient-name">@if (appt.person_id) { <a href="javascript:void(0)" (click)="onOpenChart(appt)">{{ getCellValue(appt, col.key) }}</a> } @else { {{ getCellValue(appt, col.key) }} }</td>
                } @else {
...
//# sourceMappingURL=chunk-LKQIKEST.js.map

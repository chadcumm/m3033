...
function ScheduleListComponent_Conditional_29_For_7_For_2_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275domElementStart(0, "td", 25)(1, "a", 27);
    \u0275\u0275domListener("click", function ScheduleListComponent_Conditional_29_For_7_For_2_Conditional_2_Template_a_click_1_listener() {
      \u0275\u0275restoreView(_r9);
      const appt_r7 = \u0275\u0275nextContext(2).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(2);
...
var ScheduleListComponent = class _ScheduleListComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ScheduleListComponent, selectors: [["app-schedule-list"]], decls: 34, vars: 10, consts: [[1, "schedule-container"], [1, "schedule-header"], [1, "date-nav"], [1, "nav-btn", 3, "click"], ["type", "date", 1, "date-input", 3, "change", "value"], [1, "date-separator"], [1, "today-btn", 3, "click", "disabled"], [1, "header-controls"], [1, "physician-filter"], [3, "change"], ["value", ""], [3, "value", "selected"], [1, "appt-count"], ["title", "Refresh", 1, "refresh-btn", 3, "click"], [1, "error-banner"], [1, "loading-overlay"], [1, "table-container"], [1, "empty-state"], [1, "schedule-table"], [1, "schedule-footer"], [3, "click"], [1, "spinner"], ["draggable", "true", 1, "sortable", 3, "drag-over", "dragging"], ["draggable", "true", 1, "sortable", 3, "dragstart", "dragover", "dragleave", "drop", "dragend", "click"], [1, "truncate", 3, "title"], [1, "patient-name"], [1, "status-badge"], ["href", "javascript:void(0)", 3, "click"]], template: function ScheduleListComponent_Template(rf, ctx) {
    if (rf & 1) {
...
(() => {
  ...
  <div class="schedule-header">
    <div class="date-nav">
      ...
      <input type="date" class="date-input" [value]="toIsoDate(scheduleService.startDate())" (change)="onStartDateChange($event)" />
      <span class="date-separator">to</span>
      <input type="date" class="date-input" [value]="toIsoDate(scheduleService.endDate())" (change)="onEndDateChange($event)" />
...
//# sourceMappingURL=chunk-XRUU7PDZ.js.map

...
function SecurityComponent_Conditional_18_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span", 5);
...
function SecurityComponent_Conditional_25_Template(rf, ctx) {
  if (rf & 1) {
...
function SecurityComponent_Conditional_26_For_9_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "th");
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function SecurityComponent_Conditional_26_For_13_For_6_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "td", 27)(1, "input", 30);
...
function SecurityComponent_Conditional_26_For_13_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "td", 27)(4, "input", 28);
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275repeaterCreate(5, SecurityComponent_Conditional_26_For_13_For_6_Template, 2, 2, "td", 27, _forTrack1);
    \u0275\u0275elementStart(7, "td")(8, "button", 29);
...
function SecurityComponent_Conditional_26_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 11)(1, "table", 25)(2, "thead")(3, "tr")(4, "th");
    \u0275\u0275text(5, "Position");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "th");
    \u0275\u0275text(7, "Superuser");
...
var SecurityComponent = class _SecurityComponent {
  ...
  save() {
    ...
    this.mPage.notifyUser("Security settings saved.", 3, "center", "20em", "primary");
  }
  discard() {
    const config = this.configService.configuration()?.ACCESS_CONTROL;
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SecurityComponent, selectors: [["app-security"]], decls: 32, vars: 9, consts: [[1, "security-container"], [1, "fusion-panel"], [1, "fusion-panel-header"], [1, "fusion-panel-body"], [1, "add-position"], [1, "loading-msg"], [1, "lookup-row"], ["label", "Search by name", 1, "lookup-select", 3, "ngModelChange", "ngModel", "searchable", "searchLimit"], [1, "lookup-result", 3, "lookup-added", "lookup-exists"], [1, "fusion-panel-body", 2, "padding", "0"], [1, "empty-msg"], [1, "matrix-container"], [1, "security-actions"], [1, "fusion-button", 3, "click", "disabled"], [1, "fusion-button", "fusion-outline", 3, "click", "disabled"], [1, "fusion-input", 3, "change"], ["value", ""], [3, "value"], [1, "fusion-button", "fusion-small", 3, "click", "disabled"], [1, "lookup-result"], [1, "lookup-name"], [1, "lookup-position"], [1, "fusion-badge", "badge-success"], [1, "fusion-badge", "badge-muted"], [1, "fusion-badge", "badge-danger"], [1, "fusion-grid", "compact"], [1, "position-name"], [1, "checkbox-cell"], ["type", "checkbox", 3, "change", "checked"], ["title", "Remove position", 1, "fusion-button", "fusion-danger", "fusion-small", 3, "click"], ["type", "checkbox", 3, "change", "checked", "disabled"]], template: function SecurityComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "div", 0)(1, "div", 1)(2, "div", 2)(3, "h3");
      \u0275\u0275text(4, "Add Position");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(5, "div", 3)(6, "div", 4);
      \u0275\u0275conditionalCreate(7, SecurityComponent_Conditional_7_Template, 7, 1)(8, SecurityComponent_Conditional_8_Template, 2, 0, "span", 5);
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(9, "div", 1)(10, "div", 2)(11, "h3");
      \u0275\u0275text(12, "Lookup Position by User");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(13, "p");
      \u0275\u0275text(14, "Search for a user to find their position and add it to the matrix.");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(15, "div", 3)(16, "div", 6)(17, "mpage-select", 7);
      \u0275\u0275twoWayListener("ngModelChange", function SecurityComponent_Template_mpage_select_ngModelChange_17_listener($event) {
        \u0275\u0275twoWayBindingSet(ctx.selectedPersonnelId, $event) || (ctx.selectedPersonnelId = $event);
        return $event;
      });
      \u0275\u0275listener("ngModelChange", function SecurityComponent_Template_mpage_select_ngModelChange_17_listener() {
        return ctx.onPersonnelSelected();
      });
      \u0275\u0275elementEnd();
      \u0275\u0275conditionalCreate(18, SecurityComponent_Conditional_18_Template, 2, 0, "span", 5);
      \u0275\u0275elementEnd();
      \u0275\u0275conditionalCreate(19, SecurityComponent_Conditional_19_Template, 10, 7, "div", 8);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(20, "div", 1)(21, "div", 2)(22, "h3");
    ...
    if (rf & 2) {
      ...
      \u0275\u0275advance();
      \u0275\u0275conditional(ctx.lookupLoading() ? 18 : -1);
      \u0275\u0275advance();
      \u0275\u0275conditional(ctx.lookupResult() ? 19 : -1);
      \u0275\u0275advance(6);
      \u0275\u0275conditional(ctx.configuredPositions().length === 0 ? 25 : 26);
      \u0275\u0275advance(3);
...
//# sourceMappingURL=chunk-VS2NCGMA.js.map

...
function SecurityComponent_Conditional_26_For_15_For_6_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "td", 30)(1, "input", 32);
...
function SecurityComponent_Conditional_26_For_15_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(7, "td", 30)(8, "input", 32);
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(9, "td", 33)(10, "button", 34);
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275property("checked", ctx_r1.isSuperuser(position_r6) || ctx_r1.hasTechnicalHelp(position_r6))("disabled", ctx_r1.isSuperuser(position_r6));
  }
}
function SecurityComponent_Conditional_26_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(14, SecurityComponent_Conditional_26_For_15_Template, 12, 4, "tr", null, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd()()();
...
var SecurityComponent = class _SecurityComponent {
  ...
  /** Grantable tabs only — superuser-only tabs never appear in the grid */
  tabs = ALL_TABS.filter((t) => !t.superuserOnly);
  configEffect = effect(() => {
  ...
  save() {
    ...
    this.showStatus("Security settings saved.");
  }
  showStatus(message) {
    if (this.statusTimer)
...
//# sourceMappingURL=chunk-AQTQOMP7.js.map

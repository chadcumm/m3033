...
function ScheduleListComponent_Conditional_29_For_8_Conditional_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const appt_r9 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275classProp("row-action-muted", !appt_r9.encntr_id && !appt_r9.chart_link_encntr_id);
    \u0275\u0275domProperty("title", appt_r9.encntr_id || appt_r9.chart_link_encntr_id ? "Open patient chart" : "Open patient chart (no encounter context \u2014 person only)");
  }
}
...
function ScheduleListComponent_Conditional_29_For_8_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(2, ScheduleListComponent_Conditional_29_For_8_Conditional_2_Template, 3, 3, "button", 26);
...
//# sourceMappingURL=chunk-TLUAKMXA.js.map

...
function ConfigComponent_Conditional_9_Conditional_9_Template(rf, ctx) {
  if (rf & 1) {
...
function ConfigComponent_Conditional_9_For_12_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275domElementStart(0, "label", 16)(1, "input", 17);
    \u0275\u0275domListener("change", function ConfigComponent_Conditional_9_For_12_Template_input_change_1_listener() {
...
function ConfigComponent_Conditional_9_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275domElementEnd();
    \u0275\u0275conditionalCreate(9, ConfigComponent_Conditional_9_Conditional_9_Template, 2, 1, "span", 13);
    \u0275\u0275domElementEnd();
    \u0275\u0275domElementStart(10, "div", 14);
    \u0275\u0275repeaterCreate(11, ConfigComponent_Conditional_9_For_12_Template, 3, 4, "label", 15, _forTrack0);
    \u0275\u0275domElementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275advance(6);
    \u0275\u0275conditional(ctx_r1.searchText() ? 9 : -1);
    \u0275\u0275advance(2);
...
var ConfigComponent = class _ConfigComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ConfigComponent, selectors: [["app-config"]], decls: 16, vars: 4, consts: [[1, "config-container"], [1, "config-section"], [1, "section-desc"], [1, "loading-msg"], [1, "config-actions"], [1, "save-btn", 3, "click", "disabled"], [1, "discard-btn", 3, "click", "disabled"], [1, "status-msg", 3, "class"], [1, "appt-type-controls"], ["type", "text", "placeholder", "Search appointment types...", 1, "search-input", 3, "input", "value"], [1, "selected-count"], [1, "bulk-actions"], [1, "bulk-btn", 3, "click"], [1, "bulk-hint"], [1, "appt-type-list"], [1, "appt-type-item", 3, "selected"], [1, "appt-type-item"], ["type", "checkbox", 3, "change", "checked"], [1, "status-msg"]], template: function ConfigComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275domElementEnd();
      \u0275\u0275conditionalCreate(8, ConfigComponent_Conditional_8_Template, 2, 0, "div", 3)(9, ConfigComponent_Conditional_9_Template, 13, 3);
      \u0275\u0275domElementEnd();
...
//# sourceMappingURL=chunk-2YO6XYXS.js.map
